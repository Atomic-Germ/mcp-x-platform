    ...
    const tools: Tool[] = [
      {
        ...
        description: 'Detect platform-specific API calls (Windows, macOS, Linux, POSIX)',
        inputSchema: {
          type: 'object',
          properties: {
            ...
            platforms: {
              type: 'array',
              items: { type: 'string', enum: ['windows', 'macos', 'linux', 'posix'] },
      ...
      },
      {
        ...
        description: 'Analyze file system paths for cross-platform compatibility issues',
        inputSchema: {
          type: 'object',
          properties: {
            path: { type: 'string', description: 'Directory or file path to analyze' },
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            path: { type: 'string', description: 'Directory or file path to analyze' },
            autoFix: { type: 'boolean', description: 'Suggest auto-fix options', default: false },
            preferredEnding: {
              type: 'string',
              enum: ['LF', 'CRLF', 'auto'],
      ...
      },
      {
        ...
        description: 'Analyze shell commands and scripts for cross-platform compatibility',
        inputSchema: {
          type: 'object',
          properties: {
            path: { type: 'string', description: 'Directory or file path to analyze' },
            targetShells: {
              type: 'array',
              items: { type: 'string', enum: ['bash', 'sh', 'powershell', 'cmd', 'zsh'] },
      ...
      },
      {
        ...
        description: 'Analyze dependencies for platform-specific packages and compatibility',
        inputSchema: {
          type: 'object',
          properties: {
      ...
      },
      {
        ...
        description: 'Analyze build system configurations for cross-platform compatibility',
        inputSchema: {
          type: 'object',
          properties: {
            path: { type: 'string', description: 'Project root path' },
            buildTools: {
              type: 'array',
              items: { type: 'string', enum: ['npm', 'yarn', 'pnpm', 'make', 'cmake', 'gradle'] },
      ...
      },
      {
        ...
        description: 'Detect file encoding issues that may cause cross-platform problems',
        inputSchema: {
          type: 'object',
          properties: {
            path: { type: 'string', description: 'Directory or file path to analyze' },
      ...
      },
      {
        ...
        description: 'Generate comprehensive cross-platform compatibility report',
        inputSchema: {
          type: 'object',
          properties: {
            path: { type: 'string', description: 'Project root path' },
